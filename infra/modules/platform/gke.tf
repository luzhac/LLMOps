...
resource "google_container_node_pool" "gpu" {
  ...
  # Spread the pool across every zone in the region that offers the accelerator
  # so a single-zone stockout does not block scale-up. See var.gpu_node_locations.
  #
  ...
  # i.e. up to N GPUs once node_locations lists N zones.
